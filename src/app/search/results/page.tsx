...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
    ...
    const topic = decodeURIComponent(rawQuery.q || "");
    const decodedQuery = topic.trim();
    const formatted =
    ...
    return {
        ...
        alternates: {
            canonical: `https://georadiusnews.vercel.app/search/results?q=${encodeURIComponent(topic)}`,
        },
        openGraph: {
            ...
            url: `https://georadiusnews.vercel.app/search/results?q=${encodeURIComponent(topic)}`,
